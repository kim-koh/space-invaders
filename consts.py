...
GAME_WIDTH  = 800
#: the height of the text at the top specifying lives and score
TOP_TEXT_HEIGHT = 40 
#: the height of the game display
GAME_HEIGHT = 700 - TOP_TEXT_HEIGHT
...
#holiday alternative to ALIEN_IMAGES
XMAS_IMAGES = ('xmastree.png', 'fireplace.png', 'present.png')
...
STATE_CONTINUE = 4
#state which displays either a win or lose message
STATE_WINLOSE = 5
#: state when the game is complete (won or lost)
STATE_COMPLETE = 6
#: state where menu can be viewed/navigated
STATE_MENU = 7
